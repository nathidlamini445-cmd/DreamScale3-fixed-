...
export function AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    // CRITICAL: This listener ONLY updates state. NO redirect logic allowed.
  ...
  const signOut = useCallback(async () => {
    ...
    // Only clear keys we own; never wipe storage globally (it nukes
    // unrelated third-party libraries' state).
