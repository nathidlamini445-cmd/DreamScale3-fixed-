...
import { ProWelcomeNotificationButton } from "@/components/billing/pro-welcome-notification-button"
  ...
  return (
    <header className="border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 backdrop-blur-sm">
      <div className="flex items-center justify-between px-8 py-4 mt-1">
        <div>
          <h1 className="text-3xl font-bold text-balance text-gray-900 dark:text-white flex flex-wrap items-center gap-2">
            <span>
            ...
            {isPro && (
              <ProPlanBadge active className="text-xs px-2.5 py-1 [&_svg]:w-3.5 [&_svg]:h-3.5" />
            )}
          </h1>
        ...
        <div className="flex items-center gap-4">
          ...
          <LogoutButton />
          <UserProfileAvatar
            initial={userInitialSource ?? displayFirstName ?? '?'}
            size="lg"
          />
        </div>
      </div>
