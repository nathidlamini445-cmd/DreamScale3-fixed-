...
export function EntrepreneurOnboarding({ isOpen, onClose }: EntrepreneurOnboardingProps) {
  ...
  const canProceed = () => {
    switch (currentStep) {
      ...
      case 3: return formData.businessStage !== ''
      case 4: return formData.goals.length > 0 || formData.challenges.trim() !== ''
      case 5: return Object.keys(formData.mindsetAnswers).length > 0
      case 6: return formData.hobbies.length > 0
    ...
    switch (currentStep) {
        ...
        return (
          <div className="space-y-6">
            <div className="text-center mb-8">
              <h3 className="text-2xl font-bold text-foreground mb-2">What industry are you in?</h3>
                  ...
                  <Card
                    ...
                    className={`p-4 cursor-pointer transition-all duration-300 ${
                      isSelected
                        ...
                        : 'hover:shadow-lg hover:-translate-y-1 border-gray-200 dark:border-gray-700'
                    }`}
      ...
      case 2:
        return (
          <div className="space-y-6">
            <div className="text-center mb-8">
              <h3 className="text-2xl font-bold text-foreground mb-2">What's your experience level?</h3>
              <p className="text-muted-foreground">Help us understand where you are in your entrepreneurial journey</p>
            </div>
                ...
                return (
                  ...
                  >
                    <div className="space-y-3">
                      <div className={`text-xl font-bold ${isSelected ? 'text-primary' : 'text-foreground'}`}>
                        {level.label}
                      </div>
                      <p className="text-sm text-muted-foreground">{level.description}</p>
                      <p className="text-xs text-muted-foreground italic">{level.details}</p>
                      {isSelected && (
      ...
      case 3:
        return (
          <div className="space-y-6">
            <div className="text-center mb-8">
              <h3 className="text-2xl font-bold text-foreground mb-2">What stage is your business at?</h3>
              <p className="text-muted-foreground">Tell us where you are in your business journey</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      ...
      case 4:
        return (
          <div className="space-y-6">
            <div className="text-center mb-8">
              <h3 className="text-2xl font-bold text-foreground mb-2">What are your goals and challenges?</h3>
              <p className="text-muted-foreground">Help us understand what you want to achieve</p>
            </div>
            <div className="space-y-6">
              <div>
                <label className="text-sm font-medium text-foreground mb-3 block">Select your goals (select all that apply)</label>
              ...
              <div>
                <label className="text-sm font-medium text-foreground mb-3 block">What are your biggest challenges?</label>
                <Textarea
      ...
      case 5:
        ...
        return (
          <div className="space-y-6">
            <div className="text-center mb-8">
              <h3 className="text-2xl font-bold text-foreground mb-2">A few quick questions</h3>
              <p className="text-muted-foreground">Help us understand your mindset and provide better guidance</p>
            </div>
            <div className="space-y-6">
      ...
      case 6:
        ...
        return (
          <div className="space-y-6">
            <div className="text-center mb-8">
              <h3 className="text-2xl font-bold text-foreground mb-2">What are your hobbies?</h3>
            ...
            <div className="space-y-6">
              <div>
                <label className="text-sm font-medium text-foreground mb-3 block">Select your hobbies (select all that apply)</label>
              ...
              <div>
                <label className="text-sm font-medium text-foreground mb-3 block">Add a custom hobby</label>
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="text-2xl">Welcome to DreamScale</DialogTitle>
