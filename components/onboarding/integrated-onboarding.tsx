...
export function IntegratedOnboarding({ isOpen, onClose }: IntegratedOnboardingProps) {
  ...
  const handleSubmit = async (data: OnboardingData) => {
    ...
    try {
      ...
      toast({
        title: 'Onboarding Completed!',
        description: 'Your profile is saved. Taking you home…',
        variant: 'default',
      })

      // Save entrepreneurProfile in background (don't block navigation)
      void (async () => {
        if (!user?.id) return
        try {
      ...
      // Generate tasks in the background — AI can take seconds; /tasks can also generate.
      void (async () => {
        try {
          ...
          console.log('✅ Tasks generated and saved post-onboarding')
        } catch (error) {
          console.error('⚠️ Background task generation failed:', error)
        }
      })()
