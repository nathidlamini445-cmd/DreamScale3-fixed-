...
export function IntegratedOnboarding({ isOpen, onClose }: IntegratedOnboardingProps) {
  ...
  const handleSubmit = async (data: OnboardingData) => {
    ...
    try {
      ...
      // Persist session before navigation so the next page load sees onboardingCompleted
      // (fire-and-forget caused OnboardingGuard to send users back to /onboarding).
