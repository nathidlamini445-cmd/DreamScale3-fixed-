  ...
  return (
    <Card className="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700">
      ...
      <CardContent className="space-y-4">
        {/* Personalized Reason */}
        <div className="p-3 bg-white dark:bg-blue-900/20 rounded-lg border border-gray-200 dark:border-blue-800">
            ...
            <div className="flex items-start gap-2">
              ...
              <div className="flex-1">
                <p className="text-xs font-medium text-blue-900 dark:text-blue-200 mb-1">
                  Need help reaching your goal?
                </p>
                <p className="text-xs text-blue-700 dark:text-blue-300">
                  Get personalized guidance from{' '}
                  <Link 
                    href={`/bizora?task=${encodeURIComponent(`Complete daily goal: ${goal.personalizedReason}`)}&instructions=${encodeURIComponent(JSON.stringify([`Your goal is to earn ${goal.targetXP} XP and complete ${goal.targetTasks} tasks`, `Current progress: ${currentXP}/${goal.targetXP} XP and ${currentTasks}/${goal.targetTasks} tasks`, `Difficulty level: ${goal.difficulty}`, `Estimated time: ${Math.round(goal.estimatedTime / 60 * 10) / 10} minutes`, `Personalized reason: ${goal.personalizedReason}`]))}`}
