...
export function SidebarNav() {
  ...
  useEffect(() => {
    ...
    const handleStorageChange = (e: StorageEvent) => {
      ...
      // Also update notifications when auto-setup data changes
      if (e.key === 'systembuilder:systems' || e.key === 'revenueos:data' || 
          e.key === 'leadership:data' || e.key === 'teams:data' || 
          e.key === 'autoSetupCompleted') {
    ...
    const interval = setInterval(() => {
      loadSavedPulses()
      // Check for auto-setup completion to update notifications
          ...
          return (
            <div key={index} className="space-y-1">
              ...
              >
                ...
                {/* Notification Badge - Red dot for auto-setup content */}
