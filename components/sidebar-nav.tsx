...
export function SidebarNav() {
  ...
  const navigationItems = [
    ...
    { icon: Zap, label: t("nav.discover"), labelKey: "Discover", href: "/discover", aiPowered: true },
    ...
    <aside className={`fixed left-0 top-0 h-full w-64 bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-800 z-40 flex flex-col ${inter.className}`}>
      ...
      <div className="p-6 border-b border-gray-200 dark:border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <span className="text-xl font-semibold text-gray-900 dark:text-gray-100">DreamScale</span>
        </div>
      </div>
          ...
          return (
            <div key={index} className="space-y-1">
              <Link
                ...
                className={cn(
                  "flex items-center gap-3 px-3 py-2.5 rounded-md text-sm font-medium transition-all duration-200 group relative !text-gray-700 dark:!text-white !bg-gray-100 dark:!bg-transparent hover:!bg-gray-200 dark:hover:!bg-gray-800",
              ...
              >
                <item.icon
                  className={cn(
                    ...
                    isActive ? "!text-white" : "!text-gray-500 dark:!text-white"
                  )}
                />
                <span className={cn(
                  "flex-1",
