      ...
      {assignments.length > 0 && (
        <div className="space-y-4">
          ...
          {assignments.map((assignment) => (
            <div key={assignment.id} className="p-6 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg hover:shadow-md transition-all duration-200">
              <CardHeader>
