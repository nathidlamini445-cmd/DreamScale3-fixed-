      ...
      <Card className="border border-gray-200 dark:border-gray-800">
        <CardContent className="p-6">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="team-size" className="text-sm">Team Size (Optional)</Label>
              <Input
                id="team-size"
                placeholder="e.g., 5 members, 10-15 people"
                value={teamSize}
            ...
            <div className="space-y-2">
              <Label htmlFor="current-challenges" className="text-sm">Current Challenges (Optional)</Label>
              <Input
                id="current-challenges"
                placeholder="e.g., Tight deadlines, communication gaps, workload distribution"
            ...
            <div className="space-y-2">
              <Label htmlFor="recent-changes" className="text-sm">Recent Changes (Optional)</Label>
              <Input
                id="recent-changes"
                placeholder="e.g., New team members, process changes, leadership shifts"
                value={recentChanges}
            ...
            <div className="space-y-2">
              <Label htmlFor="team-concerns" className="text-sm">Team Concerns (Optional)</Label>
              <Input
                id="team-concerns"
                placeholder="e.g., Burnout concerns, low morale, collaboration issues"
                value={teamConcerns}
                onChange={(e) => setTeamConcerns(e.target.value)}
                disabled={isAnalyzing}
                className="h-9"
              />
            </div>
