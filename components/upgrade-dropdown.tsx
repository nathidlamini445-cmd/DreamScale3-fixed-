            ...
            <div className="flex-1">
              <div className="flex items-center justify-between">
                ...
                <div className="text-right">
                  <span className="text-lg font-bold text-blue-900">$0</span>
                  <span className="text-sm text-blue-600">/month</span>
                </div>
              </div>
              <p className="text-sm text-blue-600 mt-1">Prices are coming soon</p>
        ...
        >
          <div className="flex items-start space-x-3 w-full">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-green-600 mt-1">Prices are coming soon</p>
