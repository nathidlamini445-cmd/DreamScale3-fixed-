              ...
              <div>
                ...
                <div className="space-y-4">
                  {selectedFeedback.analysis.developmentPlan.map((plan, index) => (
                    <Card key={index} className="bg-[#39d2c0]/10 border border-[#39d2c0]/20">
                      <CardHeader>
                        <CardTitle className="text-base">{plan.area}</CardTitle>
                        <CardDescription>Timeline: {plan.timeline}</CardDescription>
                      </CardHeader>
                      <CardContent>
                        <ul className="space-y-2">
      ...
      {feedback.length > 0 && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>{feedback.length} feedback entr{feedback.length !== 1 ? 'ies' : 'y'} received</CardDescription>
          </CardHeader>
          <CardContent>
