      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {quickActions.map((action, index) => (
          <Link key={index} href={action.href} onClick={() => handleCardClick(action.title)}>
            <Card className="p-6 bg-gray-50 dark:bg-gray-900 border-gray-200/60 dark:border-gray-800/60 rounded-xl hover:shadow-[0_2px_4px_0_rgba(0,0,0,0.1)] dark:hover:shadow-[0_2px_4px_0_rgba(0,0,0,0.4)] hover:-translate-y-1 hover:bg-blue-600 dark:hover:bg-gray-800 transition-all duration-300 cursor-pointer group relative h-full quick-action-card shadow-[0_1px_2px_0_rgba(0,0,0,0.05)] dark:shadow-[0_1px_2px_0_rgba(0,0,0,0.3)]">
