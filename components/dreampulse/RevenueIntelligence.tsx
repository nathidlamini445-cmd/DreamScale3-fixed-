...
export default function RevenueIntelligence() {
  ...
  return (
    <div className="space-y-6">
      ...
      {analyses.length > 0 && (
        <div className="space-y-4">
          <h3 className="text-xl font-semibold text-gray-900 dark:text-white">Revenue Analyses ({analyses.length})</h3>
          {analyses.map((analysis) => (
            <Card key={analysis.id} className="hover:shadow-lg transition-shadow">
              <CardHeader>
                ...
                <CardDescription>
                  {analysis.industry} • Analyzed on {new Date(analysis.date).toLocaleDateString()}
                </CardDescription>
              </CardHeader>
