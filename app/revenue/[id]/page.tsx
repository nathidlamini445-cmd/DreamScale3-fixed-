  ...
  useEffect(() => {
    ...
    const loadSystem = async () => {
      ...
      if (isMounted) {
        setLoading(false)
        setTimeout(() => {
          if (isMounted) router.push('/revenue?tab=dashboard')
        }, 3000)
      }
    }
            ...
            <div className="mx-auto max-w-6xl px-6 py-12">
              {loading ? (
                ...
                <div className="text-center">
                  ...
                  <Button variant="outline" size="sm" onClick={() => router.push('/revenue?tab=dashboard')}>
          ...
          <div className="border-b border-gray-100 dark:border-gray-800">
            <div className="mx-auto max-w-6xl px-6 py-5">
              <Button
                variant="ghost"
                size="sm"
                onClick={() => router.push('/revenue?tab=dashboard')}
