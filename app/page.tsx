...
export default function DashboardPage() {
  ...
  // CRITICAL: If timed out, don't show loading - render placeholder.
  // The redirect is performed by the useEffect at line 45 (which calls
  // router.replace inside an effect), so we MUST NOT call router.replace
  // here in the render body — doing so triggered a "cannot update a
  // component while rendering" warning every cycle.
  if (hasTimedOut && !user) {
    return (
