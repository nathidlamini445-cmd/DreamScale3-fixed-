...
function generateMainRecommendations(onboardingData: OnboardingData | null): Suggestion[] {
  ...
  if (!onboardingData) {
    return [
      ...
      },
      {
        ...
        howToStart: [
          'Step 1: Navigate to the Discover page and understand what it offers (8-12 sentences). Click "Discover" in the left sidebar menu - this is the vertical menu on the left side of your screen. Look for the icon that looks like a compass or the word "Discover" in the menu. When you click it, the page will load and you\'ll see the Discover interface. This is your AI-powered research and insights hub where you can ask any business question and get personalized answers. The interface typically has a search bar or chat box where you can type questions, and it may show curated content, trending topics, or recent insights. Take a moment to explore the layout - you\'ll see this is designed to be your on-demand business advisor. Unlike generic business advice you find online, this tool understands YOUR specific business context (your industry, challenges, goals) and gives you personalized guidance. Think of it like having a business consultant available 24/7 who knows your business and can answer any question. The Discover feature uses AI to analyze your question, consider your business profile, and provide tailored advice. This is powerful because generic advice often doesn\'t apply to your specific situation, but personalized advice does.',
          'Step 2: Think about a specific challenge or question you have with deep consideration (8-12 sentences). Before you start typing, take a moment to really think about what you need help with. Don\'t just ask vague questions like "how do I grow?" - be specific. Think about: What specific problem are you facing right now? What decision are you trying to make? What situation are you dealing with? For example, instead of "how do I get customers?", think "how do I find customers in the [your industry] industry who are struggling with [specific problem] and would pay for [your solution]?" The more specific your question, the better the answer will be. Include context: What have you already tried? What\'s working and what isn\'t? What constraints are you facing (budget, time, resources)? What\'s your current situation? This context helps the AI give you advice that\'s actually applicable to your situation. Also think about what kind of help you need: Are you looking for strategy? Tactics? Examples? Step-by-step instructions? Understanding what you need helps you ask better questions. Write down your question first if that helps - sometimes articulating it clearly on paper helps you clarify what you really need to know.',
          'Step 3: Type your question in the search or chat box with full context (8-12 sentences). Once you\'ve thought through your question, it\'s time to type it. Find the search bar or chat input box - it\'s usually prominently displayed, often at the top of the page or in the center. Click on it to activate it, and you\'ll see a cursor appear. Now, type your question, but remember to include context about your business. Don\'t just ask "how should I price my product?" Instead, say "I run [business name], a [industry] business that [what you do]. I\'m trying to price [specific product/service] for [target market]. Currently, I\'m thinking [your current price idea], but I\'m not sure because [your concern]. What should I consider?" This level of detail helps the AI understand your specific situation and give you relevant advice. Include information like: Your industry, your business stage, your target market, your current situation, what you\'ve tried, what your goals are, what constraints you face. The more context you provide, the better the answer. Don\'t worry about making it perfect - you can always ask follow-up questions to clarify or go deeper. Once you\'ve typed your question, review it to make sure it\'s clear and includes the necessary context, then press Enter or click the send/submit button.',
          'Step 4: Read the AI\'s response carefully and understand it fully (8-12 sentences). After you submit your question, the AI will process it and generate a response. This usually takes a few seconds - you might see a loading indicator or the AI "thinking". When the response appears, don\'t just skim it - read it carefully and thoroughly. The response will be personalized to your business and situation, so pay attention to how it applies to you specifically. Look for: Key insights or recommendations, specific steps you can take, examples or case studies, warnings about common mistakes, explanations of why certain approaches work, and connections to your business goals or challenges. As you read, think about: Does this make sense for my situation? What parts are most relevant? What questions do I still have? What would I need to do to implement this? Take notes if that helps - write down the key points, action items, or ideas that resonate with you. Don\'t just read it once - read it twice to make sure you understand it fully. The first read gives you the overview, the second read helps you catch details and think about implementation. If something isn\'t clear, that\'s okay - you can ask for clarification.',
          'Step 5: Ask follow-up questions to go deeper and get more specific guidance (8-12 sentences). The first answer is often just the beginning - you can go much deeper with follow-up questions. This is where the real value comes from. Think about what you still need to know: Was anything unclear in the response? Do you need more detail on a specific point? Do you want examples of how this would work for your business? Do you have concerns or objections? Type a follow-up question right in the same chat or search interface. For example, if the AI recommended a pricing strategy, you might ask: "Can you give me a specific example of how this would work for a [your product type] priced at [your current price]?" or "What are the risks of this approach?" or "How do I know if this is working?" The AI will remember the context of your conversation, so you don\'t need to repeat everything. You can ask multiple follow-up questions to really dig deep into the topic. This back-and-forth is like having a conversation with an expert consultant. Keep asking until you feel you have enough information to take action. Don\'t be shy about asking "dumb" questions - there are no dumb questions when you\'re learning. The goal is to understand fully, not to impress anyone.',
          'Step 6: Use the insights to inform your decisions and take action (8-12 sentences). Reading great advice is useless if you don\'t act on it. After you\'ve gotten your questions answered and understand the guidance, it\'s time to apply it. Start by identifying the key actionable insights from the conversation. What are the 2-3 most important things you learned? What are the specific steps you need to take? Then, create an action plan: What will you do? When will you do it? What do you need to prepare? What resources do you need? Break it down into small, manageable steps. Don\'t try to implement everything at once - pick the most important or easiest action and start there. For example, if you learned about a new pricing strategy, your action plan might be: Research competitor prices (this week), Calculate your costs and desired margins (this week), Test the new price with a small group (next week), Review results and adjust (following week). Set reminders or calendar events to actually do these actions - don\'t just plan and forget. As you implement, refer back to the AI\'s advice to make sure you\'re doing it correctly. And remember, you can always come back and ask more questions as you implement - the Discover feature is there whenever you need it.',
          'Step 7: Make it a habit to learn something new daily (8-12 sentences). The real power of the Discover feature comes from using it regularly, not just once. Make it a daily habit to ask one question or explore one topic. This compounds over time - one question per day means 365 new insights per year. That\'s significant learning and growth. Set a specific time each day - maybe first thing in the morning with your coffee, or at the end of the day to reflect on challenges you faced. Put it on your calendar or set a reminder. The questions don\'t have to be huge strategic questions every time - they can be tactical: "How do I handle this specific customer situation?" or "What\'s the best way to [specific task]?" or "Should I [option A] or [option B]?" Small questions lead to small improvements, which compound into big results. Over time, you\'ll build a knowledge base specific to your business. You\'ll start seeing patterns, making connections, and developing expertise. This daily learning habit is what separates successful entrepreneurs from those who stay stuck. It\'s not about having all the answers - it\'s about always learning and improving. Start today with one question, then do it again tomorrow.'
        ],
        feature: 'Discover',
        featureLink: '/discover',
        icon: 'compass',
  ...
  if (suggestions.length < 5) {
    generalRecommendations.push({
      ...
      howToStart: [
        `The Discover page is your AI-powered business advisor that understands ${businessName}'s unique context. Think of it as having a knowledgeable mentor available 24/7 who knows your industry${industry ? ` (${industry})` : ''}, your business stage${businessStage ? ` (${businessStage})` : ''}, and your specific challenges. To access it, look at the left sidebar menu - you'll see "Discover" with a lightning bolt icon and an "AI" badge. Click on it, or simply navigate to /discover in your browser. The page will load with a search interface where you can ask any business question. This isn't just a search engine - it's a contextual advisor that uses your onboarding data to provide personalized insights. When you arrive, you'll see a clean interface with a prominent search or chat box, ready for your questions.`,
        `Before typing your question, take a moment to think about what you're really trying to solve. For ${businessName}, this could be anything from "How should I price my new product?" to "What's the best way to hire my first employee?" or "How do I improve customer retention?" The key is to be specific about your situation. Instead of asking "How do I market?", ask "How should I market ${businessName} to reach my target customers in ${industry || 'my industry'}?" The more specific you are, the better the AI can tailor its advice. Think about what information would help you make a decision right now - that's what you should ask. Consider what's keeping you up at night or what decision you're procrastinating on.`,
        `Now, type your question in the search or chat box. Write it as if you're talking to a trusted advisor who knows your business. For example, instead of "pricing help," you might write: "I'm launching a new service for ${businessName} and I'm not sure how to price it. My competitors charge between $X and $Y, but I offer [specific value]. What should I consider?" Include context about your business - mention your industry, your stage, your target customers, or any relevant details. The AI uses this context plus your onboarding data to give you personalized advice. After typing, press Enter or click the send button. You'll see the AI processing your question, and within a few seconds, you'll get a comprehensive response tailored to ${businessName}.`,
        `To get the best answers, provide as much context as possible. Mention your industry${industry ? ` (${industry})` : ''} - this helps the AI understand market dynamics, customer expectations, and industry-specific challenges. Include your business stage${businessStage ? ` (${businessStage})` : ''} - whether you're just starting or scaling, the advice will differ. Share relevant details like your target market, current challenges, or specific constraints. For example, if asking about hiring, mention your team size, budget, and what role you need. The AI combines this context with your saved onboarding data to give you advice that's truly relevant to ${businessName}. You don't need to repeat everything - the AI remembers your business name, industry, and stage from onboarding - but adding current context makes answers more actionable.`,
        `When the AI responds, read it carefully. The response will be personalized to ${businessName} and your situation. It won't be generic advice - it will reference your industry, your stage, and your specific context. Look for actionable recommendations, specific examples, and explanations of why certain approaches work. The AI might suggest multiple options or approaches, each with pros and cons. Take your time to understand each recommendation. If something isn't clear, that's okay - you can ask follow-up questions. The response is designed to be educational, not just prescriptive, so you'll understand not just what to do, but why it matters for your business.`,
        `Don't stop at the first answer - ask follow-up questions to go deeper. You can ask things like "Can you explain that more?" or "What would that look like for ${businessName} specifically?" or "How do I implement that step-by-step?" The AI is designed for conversation, so treat it like a dialogue. For example, if the AI suggests "improve your pricing strategy," you might follow up with "What pricing model works best for ${industry || 'my industry'} businesses at my stage?" Each follow-up question helps you get more specific, actionable advice. You can ask about implementation details, potential pitfalls, success metrics, or how to adapt the advice to your unique situation. The more you engage, the more valuable the insights become.`,
        `After getting insights, use them to inform your decisions. Take notes on what resonates with you - you might want to copy key recommendations into a document or your task management system. Create specific action items from the advice. For example, if the AI suggests "analyze your customer feedback," create an action item like "Review last month's customer feedback and identify top 3 pain points." Don't just read and forget - the value comes from taking action. You can also save important insights by taking screenshots or copying them to a notes app. Consider sharing insights with your team if you have one, or discussing them with a mentor or advisor. The goal is to turn the AI's advice into real changes for ${businessName}.`,
        `Remember, this AI advisor is available 24/7, so come back anytime you have a question. Whether it's 2 AM and you're stuck on a decision, or you're in a meeting and need quick context, the Discover page is always there. You don't need to schedule a call or wait for business hours - just open the page and ask. Over time, as you use it more, the AI gets better at understanding your specific needs and preferences. Make it a habit to check in regularly, especially when facing decisions or challenges. Think of it as your always-available business consultant who never gets tired, never judges, and always has your business's best interests in mind.`
      ],
      feature: 'Discover',
      featureLink: '/discover',
      icon: 'compass',
  ...
  if (suggestions.length < 5) {
    generalRecommendations.push({
      ...
      howToStart: [
        `Competitive intelligence is about understanding your market landscape so you can find your unique position and avoid competing on the same terms as everyone else. For ${businessName}${industry ? ` in ${industry}` : ''}, this means knowing who else is solving similar problems for your target customers. To get started, open the Discover page by clicking "Discover" in the left sidebar menu (it has a lightning bolt icon and an "AI" badge). Once you're on the Discover page, look for the "Competitor Intelligence" section or tab. This feature uses AI to help you analyze competitors systematically. The interface will guide you through entering competitor information and will help you analyze their strategies, strengths, and weaknesses. You can also access competitor intelligence through the dedicated "Competitor Intelligence" link in the sidebar. The tool is designed to help you understand not just who your competitors are, but how they operate, what they do well, where they struggle, and what opportunities they're missing. This isn't about copying them - it's about finding where you can win.`,
...
export default function SuggestionsPage() {
  ...
  useEffect(() => {
    const loadSuggestions = async () => {
      ...
      // Always generate fresh AI recommendations if onboarding data exists
      // Clear any old cached recommendations to ensure fresh, personalized ones
      // This ensures new users and users who update their onboarding get personalized recommendations
      if (data) {
        ...
        localStorage.removeItem('homePageRecommendations')
        
        try {
          console.log('🔄 Generating fresh AI recommendations from onboarding data...', {
          ...
          if (response.ok) {
            ...
            console.log('✅ AI recommendations received:', result.recommendations?.length || 0, 'recommendations')
        ...
        // If AI generation fails but we have onboarding data, retry once
        console.warn('⚠️ First attempt failed, retrying AI recommendation generation...')
        try {
          const retryResponse = await fetch('/api/suggestions/generate', {
            method: 'POST',
            headers: {
              'Content-Type': 'application/json',
            },
          ...
          if (retryResponse.ok) {
            ...
            if (retryResult.recommendations && Array.isArray(retryResult.recommendations) && retryResult.recommendations.length > 0) {
              console.log('✅ Retry successful, got', retryResult.recommendations.length, 'recommendations')
              setMainSuggestions(retryResult.recommendations)
              const dailyRecs = generateDailyRecommendations(data, new Date())
              setDailySuggestions(dailyRecs)
              localStorage.setItem('mainRecommendations', JSON.stringify(retryResult.recommendations))
              localStorage.setItem('dailyRecommendations', JSON.stringify(dailyRecs))
              setIsLoading(false)
              return
            }
        ...
        // If both attempts fail, show empty state with message
        console.error('❌ AI recommendation generation failed after retry. User has onboarding data, so not using hardcoded fallback.')
        setMainSuggestions([])
        const dailyRecs = generateDailyRecommendations(data, new Date())
        setDailySuggestions(dailyRecs)
        setIsLoading(false)
      ...
      // Only use hardcoded fallback if there's NO onboarding data
    ...
    try {
      ...
      if (response.ok) {
        ...
        if (result.recommendations && Array.isArray(result.recommendations)) {
          ...
          const dailyRecs = generateDailyRecommendations(onboardingData, new Date())
          setDailySuggestions(dailyRecs)
          // Save to localStorage
          localStorage.setItem('mainRecommendations', JSON.stringify(result.recommendations))
          localStorage.setItem('dailyRecommendations', JSON.stringify(dailyRecs))
  ...
  const loadingMessages = [
    ...
    "Go make a coffee ☕",
    "Cooking up a cool roadmap for you",
              ...
              <section>
                ...
                <div className="space-y-6">
                  {deepFocusAreas.map((area) => {
                    ...
                    return (
                      <Card key={area.id} className="p-6 bg-white dark:bg-gray-900 border-gray-200/60 dark:border-gray-800/60 shadow-[0_1px_2px_0_rgba(0,0,0,0.05)] dark:shadow-[0_1px_2px_0_rgba(0,0,0,0.3)]">
