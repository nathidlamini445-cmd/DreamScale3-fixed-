...
function generateMainRecommendations(onboardingData: OnboardingData | null): Suggestion[] {
  ...
  if (!onboardingData) {
    return [
      ...
      },
      {
        ...
        howToStart: [
          'Step 1: Navigate to Bizora AI and understand what it offers (8-12 sentences). Click "Bizora AI" in the left sidebar menu - this is the vertical menu on the left side of your screen. Look for the icon that looks like connected circles or the words "Bizora AI" in the menu. When you click it, the page will load and you\'ll see the Bizora AI interface. This is your AI-powered business advisor where you can ask any business question and get personalized answers. The interface typically has a chat box where you can type questions, and it may show conversation history or recent insights. Take a moment to explore the layout - you\'ll see this is designed to be your on-demand business advisor. Unlike generic business advice you find online, this tool understands YOUR specific business context (your industry, challenges, goals) and gives you personalized guidance. Think of it like having a business consultant available 24/7 who knows your business and can answer any question. Bizora AI uses advanced AI to analyze your question, consider your business profile, and provide tailored advice. This is powerful because generic advice often doesn\'t apply to your specific situation, but personalized advice does.',
  ...
  if (suggestions.length < 5) {
    generalRecommendations.push({
      ...
      howToStart: [
        `Bizora AI is your AI-powered business advisor that understands ${businessName}'s unique context. Think of it as having a knowledgeable mentor available 24/7 who knows your industry${industry ? ` (${industry})` : ''}, your business stage${businessStage ? ` (${businessStage})` : ''}, and your specific challenges. To access it, look at the left sidebar menu - you'll see "Bizora AI" with an interconnected circles icon and an "AI" badge. Click on it, or simply navigate to /bizora in your browser. The page will load with a chat interface where you can ask any business question. This isn't just a search engine - it's a contextual advisor that uses your onboarding data to provide personalized insights. When you arrive, you'll see a clean interface with a prominent chat box, ready for your questions.`,
...
function generateDailyRecommendations(onboardingData: OnboardingData | null, date: Date): Suggestion[] {
  ...
  dailyActions.push({
    id: 'daily-gen-1',
    title: `Ask One Business Question in Bizora AI`,
    description: `Get AI guidance on a specific challenge for ${businessName}`,
    explanation: `Every day brings new questions and challenges. For ${businessName}, using Bizora AI to ask one specific question today helps you get unstuck, learn something new, or validate a decision. It's like having a business advisor available 24/7.`,
    ...
    howToStart: [
      `Open Bizora AI by clicking "Bizora AI" in the left sidebar menu, or go to /bizora.`,
      ...
      `Type your question in the chat box. Be specific and include context about your business${industry ? ` (you're in ${industry})` : ''}${businessStage ? ` (you're at ${businessStage} stage)` : ''}.`,
...
export default function SuggestionsPage() {
  ...
  useEffect(() => {
    const loadSuggestions = () => {
      ...
      // Load cached recommendations if they exist
      const cachedMain = localStorage.getItem('mainRecommendations')
      const cachedDaily = localStorage.getItem('dailyRecommendations')
      ...
      // If no cached recommendations and no onboarding data, use hardcoded fallback
      if (!cachedMain && !data) {
  ...
  const generateRecommendations = async (requestDifferent: boolean = false) => {
    ...
    // Minimum loading time to ensure AI processing (longer for different requests)
    const minLoadingTime = new Promise(resolve => setTimeout(resolve, requestDifferent ? 8000 : 5000))
    ...
    try {
      ...
      if (response.ok) {
        ...
        console.log('✅ AI recommendations received:', result.recommendations?.length || 0, 'recommendations', requestDifferent ? '(DIFFERENT)' : '')
      ...
      // Only fallback if it's a real error, not just a timeout
              ...
              <div className="text-center space-y-4 max-w-md">
                ...
                {onboardingData ? (
                  <button
                    ...
                    disabled={isLoading}
                    className="px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 border border-blue-300 dark:border-blue-700 rounded-md hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                  >
