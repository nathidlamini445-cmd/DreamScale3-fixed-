...
// Lazy-load + validate so misconfig fails loudly. Never fall back to a public
// key (the previous fallback to NEXT_PUBLIC_SUPABASE_ANON_KEY made every
// download token forgeable from the browser bundle).
