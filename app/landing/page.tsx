...
export default function LandingPage() {
  ...
  const handleGoToDashboard = () => {
    ...
    // If user is authenticated and onboarded, they should be routed to / by /auth/resolve
    // This button should not exist if user is already authenticated and onboarded
    console.log('🚫 REMOVED: Redirect logic - /auth/resolve handles all routing')
  }
