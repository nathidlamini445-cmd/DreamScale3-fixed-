...
function DreamPulseContent() {
  ...
  // Enable scrolling on DreamPulse page
  useEffect(() => {
...
export default function DreamPulsePage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-50 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950 text-foreground relative" style={{ overflowY: 'auto', height: 'auto', minHeight: '100vh' }}>
