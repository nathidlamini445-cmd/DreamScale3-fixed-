          ...
          <div className="space-y-6">
              ...
              <CardContent className="pt-6">
                <div className="flex items-center justify-center">
                  <div className="text-center">
                    <div className={cn("text-5xl font-bold mb-2", getMatchColor(match.matchScore))}>
                      {match.matchScore}%
                    </div>
                    <p className="text-lg text-gray-600 dark:text-gray-400">Compatibility Score</p>
                    <div className="mt-4 w-64">
                      <Progress value={match.matchScore} className="h-4" />
                    </div>
                  </div>
                </div>
              </CardContent>
            ...
            {match.matchingCharacteristics ? (
              ...
              <Card className="bg-purple-50 dark:bg-purple-900/20">
                <CardContent className="pt-6">
                  <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">Ideal Co-founder Profile</h2>
            ...
            {match.trialPeriod && (
              <Card className="bg-green-50 dark:bg-green-900/20 border-l-4 border-green-500">
                <CardContent className="pt-6">
                  <h2 className="text-xl font-semibold text-green-800 dark:text-green-200 mb-4">Suggested Trial Period</h2>
