...
export default function CoFounderMatchDetailPage() {
  ...
  // Helper function to extract skill name (remove examples in parentheses)
  const cleanSkillName = (skill: string): string => {
    // Remove everything after "(" or "(" or "e.g." or "("
    const cleaned = skill
      .split('(')[0]  // Remove everything after opening parenthesis
      .split('e.g.')[0]  // Remove everything after "e.g."
      .split('(')[0]  // Remove everything after opening parenthesis (again for safety)
      .trim()
    return cleaned
  }
