        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          ...
          {match.matchingCharacteristics && (
            <div className="grid md:grid-cols-3 gap-6 mb-6">
              ...
              <div className="md:col-span-1 border border-gray-200/50 dark:border-gray-800/50 rounded p-4 bg-white dark:bg-slate-950">
              ...
              {/* Must Match and Can Match - Right Side */}
                      ...
                      <div className="flex flex-wrap gap-2">
                        {match.matchingCharacteristics.mustMatch.skills.map((skill, i) => (
                          <Badge 
                            key={i} 
                            variant="outline" 
                            className="text-xs px-2 py-1 border-red-200 dark:border-red-800 text-red-600 dark:text-red-400 bg-red-50/50 dark:bg-red-950/20 max-w-full truncate"
                            title={skill}
                          >
                      ...
                      <div className="flex flex-wrap gap-2">
                        {match.matchingCharacteristics.canMatch.skills.map((skill, i) => (
                          <Badge 
                            key={i} 
                            variant="outline" 
                            className="text-xs px-2 py-1 border-green-200 dark:border-green-800 text-green-600 dark:text-green-400 bg-green-50/50 dark:bg-green-950/20 max-w-full truncate"
                            title={skill}
                          >
                            {skill.length > 30 ? `${skill.substring(0, 30)}...` : skill}
                          </Badge>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {match.matchingCharacteristics.canMatch.hobbies.map((hobby, i) => (
                          <Badge 
                            ...
                            title={hobby}
                          >
                            {hobby.length > 30 ? `${hobby.substring(0, 30)}...` : hobby}
                          </Badge>
                        ))}
                      </div>
                    </div>
