        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          ...
          {match.matchingCharacteristics && (
            <div className="grid md:grid-cols-2 gap-6 mb-6">
              {/* Must Match */}
              <div className="border-l-2 border-l-red-500 border border-gray-200/50 dark:border-gray-800/50 rounded p-5 bg-white dark:bg-slate-950">
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {match.matchingCharacteristics.mustMatch.skills.map((skill, i) => (
                          <Badge key={i} variant="outline" className="text-xs px-2 py-1 border-red-200 dark:border-red-800 text-red-600 dark:text-red-400 bg-red-50/50 dark:bg-red-950/20">
                            {skill}
                          </Badge>
                        ))}
                      </div>
              ...
              {/* Can Match */}
              <div className="border-l-2 border-l-green-500 border border-gray-200/50 dark:border-gray-800/50 rounded p-5 bg-white dark:bg-slate-950">
                <div className="flex items-center gap-2 mb-2">
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {match.matchingCharacteristics.canMatch.skills.map((skill, i) => (
                          <Badge key={i} variant="outline" className="text-xs px-2 py-1 border-green-200 dark:border-green-800 text-green-600 dark:text-green-400 bg-green-50/50 dark:bg-green-950/20">
                            {skill}
                          </Badge>
                        ))}
                      </div>
