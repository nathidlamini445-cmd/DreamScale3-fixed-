...
import { Play, ExternalLink, Calendar, User, TrendingUp, Eye, Save, Maximize2, HelpCircle, MessageSquare } from "lucide-react"
            ...
            <div className="grid grid-cols-1 xl:grid-cols-4 gap-8">
              ...
              <div className="xl:col-span-3 space-y-8">
                ...
                <div className="p-6 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg hover:shadow-md transition-all duration-200">
                  ...
                  >
                    <img 
                      src={videoThumbnails[featuredVideos[0].videoId] || featuredVideos[0].thumbnail} 
                      alt={featuredVideos[0].title}
                      className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300"
                      onError={(e) => {
                        const target = e.target as HTMLImageElement;
                        target.src = "https://via.placeholder.com/800x450/1a1a2e/ffffff?text=TED+Talk";
                      }}
                    />
                ...
                <div>
                  <h2 className="text-3xl font-bold text-foreground mb-6 flex items-center gap-3">
                    ...
                    Business Legends & Their Stories
                  </h2>
                ...
                {/* Additional Videos */}
                <div>
                  <h2 className="text-2xl font-bold text-foreground mb-6">More Inspiring TED Talks</h2>
