...
Please provide personalized guidance on how to complete this task. Give me detailed, actionable steps tailored to my situation.`
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white dark:bg-slate-950" style={{ fontFamily: '"Libre Baskerville", serif' }}>
                    ...
                    <div className={`max-w-3xl ${message.role === 'user' ? 'order-2' : 'order-1'}`}>
                      ...
                      {message.role === 'user' ? (
                        <div className="rounded-2xl p-5 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700">
                          <p className="text-xl font-medium text-black dark:text-white leading-relaxed" style={{ fontFamily: '"Libre Baskerville", serif', textShadow: '0 1px 1px rgba(0, 0, 0, 0.04)' }}>
                            {message.content}
                          </p>
                        </div>
                      ) : (
            ...
            <div className="flex gap-2 items-end">
              <div className="flex-1 relative">
                <textarea
                  ...
                  className={`w-full min-h-[48px] max-h-96 resize-none rounded-lg pr-24 border dark:bg-gray-800 dark:text-white focus:border-[#39d2c0] focus:ring-2 focus:ring-[#39d2c0]/20 focus:shadow-sm focus:shadow-[#39d2c0]/10 p-2.5 text-sm transition-all duration-200 overflow-y-auto text-black ${
                    showGlowEffect 
