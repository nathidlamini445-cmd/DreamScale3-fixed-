    ...
    const resolveAuth = async () => {
      try {
        ...
        if (shouldGoToOnboarding) {
          ...
          console.log('✅ [AUTH RESOLVE] User onboarded - redirecting to /auth/welcome (greeting → dashboard)')
          // Hard redirect to the welcome page; it shows a 3s greeting and then
          // hard-navigates to the dashboard ("/").
          if (typeof window !== 'undefined') {
