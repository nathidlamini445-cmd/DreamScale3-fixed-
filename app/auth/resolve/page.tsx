...
/** Wall-clock cap must exceed: cookie delay + session poll window + profile race (see resolveAuth). */
const HARD_FALLBACK_MS = 48_000
  ...
  useEffect(() => {
    ...
    async function resolveAuth() {
      try {
        ...
        // Wait for OAuth callback cookies to settle in the browser before polling
