...
export default function HypeOSPage() {
  ...
  const [showOnboarding, setShowOnboarding] = useState(() => {
    ...
    return true; // Default to true (show onboarding) if no session data
  });
  ...
  // If user exists but has no goal, show onboarding
  ...
  return (
    <div className="hypeos-page min-h-screen bg-white dark:bg-slate-950">
      {/* Top Navigation */}
