...
export default function HypeOSPage() {
  ...
  return (
    <div className="hypeos-page min-h-screen bg-gray-50 dark:bg-slate-950">
      {/* Back Button */}
      <div className="fixed top-4 left-4 z-50">
        <Link
          href="/"
      ...
      <div className="container mx-auto px-6 py-12 max-w-7xl">
        ...
        <div className="mb-12">
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex items-center space-x-4">
              ...
              <Button 
                className="bg-gray-900 hover:bg-gray-800 text-white dark:bg-gray-800 dark:text-white dark:hover:bg-gray-700 font-medium"
                onClick={() => setShowOnboarding(true)}
              >
          ...
          {user && (
            <div className="mt-6 p-5 bg-gray-50 dark:bg-slate-900 rounded-lg border border-gray-200 dark:border-gray-800 shadow-sm">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-2">
                  <Badge className="bg-gray-100 text-gray-700 dark:bg-gray-800 dark:text-gray-300 border-0 font-medium">
                    {tasks.filter(t => t.completed).length}/{tasks.length} Tasks
                  </Badge>
                  <Badge variant="outline" className="font-medium text-gray-900 dark:text-white">
        ...
        {user && (
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-10">
            <Card className="bg-gray-50 dark:bg-slate-900 border border-gray-200 dark:border-gray-800 shadow-sm hover:shadow transition-shadow">
              <CardContent className="p-5">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <p className="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wide mb-1">Current Streak</p>
                    <p className="text-2xl font-semibold text-gray-900 dark:text-white">{user?.currentStreak || 0}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="p-5">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-2xl font-semibold text-gray-900 dark:text-white">{user?.level || 1}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="bg-gray-50 dark:bg-slate-900 border border-gray-200 dark:border-gray-800 shadow-sm hover:shadow transition-shadow">
              <CardContent className="p-5">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <p className="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wide mb-1">Hype Points</p>
                    <p className="text-2xl font-semibold text-gray-900 dark:text-white">{(user?.hypePoints || 0).toLocaleString()}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="bg-gray-50 dark:bg-slate-900 border border-gray-200 dark:border-gray-800 shadow-sm hover:shadow transition-shadow">
              <CardContent className="p-5">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <p className="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wide mb-1">Longest Streak</p>
                    <p className="text-2xl font-semibold text-gray-900 dark:text-white">{user?.longestStreak || 0}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
