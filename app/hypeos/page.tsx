        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="flex justify-between mt-10">
            ...
            <Button 
              ...
              className="bg-gray-900 hover:bg-gray-800 text-white dark:bg-white dark:text-gray-900 dark:hover:bg-gray-100 font-medium disabled:opacity-50"
            >
              {currentStep === 2 ? (
                <>
                  Start My Journey
            ...
            {dailyGoal && (() => {
              ...
              return (
                <div className="mb-12">
                  ...
                  {/* Dark blue info box */}
                  <div className="bg-blue-900/30 dark:bg-blue-900/20 border border-blue-800/50 dark:border-blue-700/50 rounded-lg p-4 mb-6">
                        ...
                        >
                          <CardContent className="p-5">
                            <div className="flex items-start justify-between mb-4">
                              ...
                              {isActive && (
                                <Badge className="bg-gray-900 text-white dark:bg-white dark:text-gray-900 border-0 font-medium text-xs">
                                  Active
                                </Badge>
                              )}
                            </div>
