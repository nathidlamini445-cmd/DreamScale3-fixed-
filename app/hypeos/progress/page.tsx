...
export default function ProgressPage() {
  ...
  const loadData = () => {
    try {
      // Load from dreamscale_session (same as other HypeOS pages)
      ...
      <div className="container mx-auto px-6 py-12 max-w-7xl">
        ...
        <div className="flex items-center justify-between mb-10">
          ...
          <div className="flex space-x-2">
            <Button variant="outline" size="sm" className="border-gray-200 dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-gray-900 font-medium">
          ...
          <Card className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-gray-800 shadow-sm">
            <CardContent className="p-5">
              <div className="flex items-center space-x-3 mb-3">
                ...
                <span className="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wide">Total Points</span>
              </div>
          ...
          <Card className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-gray-800 shadow-sm">
            <CardContent className="p-5">
              <div className="flex items-center space-x-3 mb-3">
                ...
                <span className="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wide">Growth Velocity</span>
              </div>
              <div className="text-2xl font-semibold text-gray-900 dark:text-white mb-1">
                +2.3x
              </div>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
              {analytics.categoryBreakdown.map((category, index) => (
                <div key={index} className="text-center p-4 bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
                  <div className="text-2xl font-semibold text-gray-900 dark:text-white mb-1">
                    {category.points}
                  </div>
